...
#[ORM\Entity(repositoryClass: EconomicRepository::class)]
class Economic
{
    #[ORM\Id]
    #[ORM\GeneratedValue]
    ...
    #[ORM\ManyToOne(inversedBy: 'economicFactor')]
    private ?Factors $factor = null;

    #[ORM\ManyToOne(inversedBy: 'economics')]
    ...
    #[ORM\ManyToOne(inversedBy: 'economicCreate')]
    private ?Users $userCreate = null;

    #[ORM\Column(type: Types::DATETIME_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $dateCreate = null;

    #[ORM\ManyToOne(inversedBy: 'economicUpdate')]
