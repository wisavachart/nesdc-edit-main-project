...
class Houses
{
    ...
    #[ORM\ManyToOne(inversedBy: 'provinceHouses')]
    ...
    #[ORM\ManyToOne(inversedBy: 'housesCreate')]
    private ?Users $userCreate = null;

    #[ORM\Column(type: Types::DATETIME_MUTABLE, nullable: true)]
    private ?\DateTimeInterface $dateCreate = null;

    #[ORM\ManyToOne(inversedBy: 'housesUpdate')]
    ...
    #[ORM\ManyToOne(inversedBy: 'housesFactor')]
